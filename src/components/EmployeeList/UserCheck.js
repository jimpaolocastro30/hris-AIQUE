...
function getEquip(){
  axios.get("http://localhost:3001/api/getEquip?email="+Emailad).then((response)=>{
...
/// axios update///
 const UpdateDepartment = (id)=>{
   ...
   Axios.put("http://localhost:3001/api/update/department/:id",{
     id:id,
  ...
  async function UpdateDeptHistory(id, dev){
    Axios.post(`http://localhost:3001/UserMngmnt/updateDept/:id`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:department,
...
//////
   const UpdatePosition = (id)=>{
     ...
     Axios.put("http://localhost:3001/api/update/position/:id",{
       id:id,
     ...
     async function UpdatePositionHistory(id, dev){
      Axios.post(`http://localhost:3001/UserMngmnt/updatePosition/:id`,{
        devbefore:dev,
        fullName:hEmail,
        date:hdate,
        method:position,
  ...
  ///////
     const UpdateImmSuperior = (id)=>{
       ...
       Axios.put("http://localhost:3001/api/update/immSuperior/:id",{
         id:id,
       ...
       async function UpdateImmSuperiorHistory(id, dev){
        Axios.post(`http://localhost:3001/UserMngmnt/updateSuperior/:id`,{
          devbefore:dev,
          fullName:hEmail,
          date:hdate,
          method:immSuperior,
      ...
      ////////////
       ...
       const EmPerToContact = (id)=>{
         ...
         Axios.put("http://localhost:3001/api/update/EmPerToContact/:id",{
           id:id,
         ...
         async function UpdateEmPerToContactHistory(id, dev){
          Axios.post(`http://localhost:3001/UserMngmnt/updateEmPerToContact/:id`,{
            devbefore:dev,
            fullName:hEmail,
            date:hdate,
            method:EmPerContact,
        ...
        /////////////
         const UpdateSSS = (id)=>{
           ...
           Axios.put("http://localhost:3001/api/update/SSS/:id",{
             id:id,
             newSSS : sSS
           ...
           async function UpdateSSSHistory(id, dev){
            Axios.post(`http://localhost:3001/UserMngmnt/updateSSS/:id`,{
              devbefore:dev,
              fullName:hEmail,
              date:hdate,
              method:sSS,
          ...
          ///////////
           const UpdatePagIbig = (id)=>{
             ...
             Axios.put("http://localhost:3001/api/update/pagIbig/:id",{
               id:id,
               newPagIbig : pagIbig
             ...
             async function UpdatePagIbigHistory(id, dev){
              Axios.post(`http://localhost:3001/UserMngmnt/updatePagibig/:id`,{
                devbefore:dev,
                fullName:hEmail,
                date:hdate,
                method:pagIbig,
            ...
            /////////
             const UpdateTinID = (id)=>{
               ...
               Axios.put("http://localhost:3001/api/update/tinId/:id",{
                 id:id,
                 newTinID : tinId
               ...
               async function UpdateTinIDHistory(id, dev){
                Axios.post(`http://localhost:3001/UserMngmnt/updateTinID/:id`,{
                  devbefore:dev,
                  fullName:hEmail,
                  date:hdate,
                  method:tinId,
            ...
            //////////
               const UpdateEmpStatus = (id)=>{
                ...
                Axios.put("http://localhost:3001/api/update/empStatus/:id",{
                  id:id,
                  newEmpStatus : Status
                ...
                async function UpdateStatusHistory(id, dev){
                  Axios.post(`http://localhost:3001/UserMngmnt/updateStatus/:id`,{
                    devbefore:dev,
                    fullName:hEmail,
                    date:hdate,
                    method:Status,
...
const [showSalary, setShowSalary]=useState(false)
  const findProfile = ( )=>{
    Axios.get('http://localhost:3001/api/EmpProf/?Emailad='+Emailad).then((response)=>{
