...
///////hide/unhide////////////
  ...
  const updateDevHistory = async (id, dev)=>{
    Axios.post(`http://localhost:3001/InvHistory/Updatedev/:id`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:updevice
  ...
  const updateStatusHistory = async (id, dev)=>{
    Axios.post(`http://localhost:3001/InvHistory/UpdateStatus/${id}`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:upStatus,
  ...
  const updateDevNumHistory = async (id, dev)=>{
    Axios.post(`http://localhost:3001/InvHistory/UpdateDevNum/${id}`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:upDevNum,
...
//////
  const UpdateSpec = (id) => {
    Axios.put("http://localhost:3001/admin/update/spec/:id", {
      id: id,
      newSpec: upSpec,
    })
      .then((res) => {
  ...
  const updateSpecHistory = async (id, dev)=>{
    Axios.post(`http://localhost:3001/InvHistory/UpdateSpec/${id}`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:upSpec,
...
//////
  ...
  const updateProviderHistory = async (id, dev)=>{
    Axios.post(`http://localhost:3001/InvHistory/UpdateProvider/${id}`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:upProvider,
  ...
  const updatePriceHistory = async (id, dev)=>{
    Axios.post(`http://localhost:3001/InvHistory/UpdatePrice/${id}`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:UpPrice,
  ...
  const UpdateDateHistory = async (id, dev)=>{
    Axios.post(`http://localhost:3001/InvHistory/UpdateDate/${id}`,{
      devbefore:dev,
      fullName:hEmail,
      date:hdate,
      method:upDate,
...
const updateInvDev = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/Devices/:id", {
    id: id,
...
const updateInvDevHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateDevices/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
    method:InvUpdevices,
...
const updateInvFullName = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/name/:id", {
    id: id,
...
const updateInvNameHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateInvName/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
...
const updateInvEmail = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/email/:id", {
    id: id,
    newEmail:InvUpEmail,
  })
    .then((res) => {
...
const updateInvEmailHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateInvEmail/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
    method:InvUpEmail,
...
const updateInvSpecs = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/specs/:id", {
    id: id,
    newSpecs:InvUpSpecs,
  })
    .then((res) => {
...
const updateInvSpecsHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateInvSpecs/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
    method:InvUpSpecs,
...
const updateInvPosition = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/position/:id", {
    id: id,
...
const updateInvPositionHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateInvPosition/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
...
const updateInvDept = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/dept/:id", {
    id: id,
    newDept:InvUpDept,
  })
    .then((res) => {
...
const updateInvDeptHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateInvDept/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
    method:InvUpDept,
...
const updateInvDevNums = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/deviceNums/:id", {
    id: id,
...
const updateInvDevNumsHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateInvDevNums/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
...
const updateInvDate = (id) => {
  Axios.put("http://localhost:3001/InvMngmnt/update/date/:id", {
    id: id,
    newDate:InvUpDate,
  })
    .then((res) => {
...
const updateInvDateHistory = async (id, dev)=>{
  Axios.post(`http://localhost:3001/InvHistory/UpdateInvDate/:id`,{
    devbefore:dev,
    fullName:hEmail,
    date:hdate,
    method:InvUpDate,
...
const InventoryDelete = async (id)=>{
  ...
  try {
  await Axios.post(`http://localhost:3001/admin/delete/${id}`,{
        fullName:hEmail,
        id:id,
        date:hdate,
  })
...
const InventoryMngmntDelete = async (id)=>{
  ...
  try {
  await Axios.post(`http://localhost:3001/InvMngmnt/delete/${id}`,{
        fullName:hEmail,
        id:id,
        date:hdate,
  })
  ...
  const fetchData = () => {
    ...
    Axios.get("http://localhost:3001/admin/read/", options).then((response) => {
      setInventoryList(response.data);
      ///////////////////

      Axios.get("http://localhost:3001/admin/Status?Status=Reserved", options).then((response) => {
      setResCount(response.data.result)
    })
    Axios.get("http://localhost:3001/admin/Status?Status=Used", options).then((response) => {
      setUsedCount(response.data.result)
    })
    Axios.get("http://localhost:3001/admin/Status?Status=New", options).then((response) => {
      setNewCount(response.data.result)
    })
    Axios.get("http://localhost:3001/admin/Status?Status=To Repair", options).then((response) => {
      setToRepCount(response.data.result)
    })
    Axios.get("http://localhost:3001/admin/Status?Status=Decomisioned", options).then((response) => {
      setDecomCount(response.data.result)
    })

  
      ///////////////////
      Axios.get("http://localhost:3001/admin/stock?device=Laptop").then(
        (response) => {
          setLaptopStocks(response.data.result);
        }
      );
      Axios.get("http://localhost:3001/admin/stock?device=Mouse").then(
        (response) => {
          setMouseStocks(response.data.result);
        }
      );
      Axios.get("http://localhost:3001/admin/stock?device=Monitor").then(
        (response) => {
          setMonitorStocks(response.data.result);
        }
      );
      Axios.get("http://localhost:3001/admin/stock?device=Keyboard").then(
        (response) => {
  ...
  const showDataInv = ()=>{
     Axios.get("http://localhost:3001/InvMngmnt/read/").then((response) => {
  ...
  const deleteInvMngmt = (id) => {
    ...
    console.log(user);
    Axios.delete(`http://localhost:3001/InvMngmnt/delete/${id}`,).then(
      (res) => {
        swal
          .fire({
            position: "center",
...
//////////////////////////////////
  ...
  const deleteInvItem = (id) => {
    ...
    Axios.delete(`http://localhost:3001/admin/delete/${id}`, options).then(
      (res) => {
        swal
          .fire({
            position: "center",
...
///////Inv Management delete//////////

  {
    ...
    const findDevNum = ( )=>{
      Axios.get("http://localhost:3001/read/deviceNum?deviceNum="+search).then((response)=>{
