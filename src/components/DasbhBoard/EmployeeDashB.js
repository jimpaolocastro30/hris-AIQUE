...
Axios.get('http://13.229.91.120:3001/Ann/Announcement').then((response)=>{
...
const addAnnouncement = () => {
    try{
      ...
      Axios.post("http://13.229.91.120:3001/Ann/insert", {
        user:emailId,
        date:date,
        tag:tag,
...
async function DeleteAnnouncement(id){
    Axios.delete(`http://13.229.91.120:3001/Ann/delete/${id}`,{
        id:id
    }).then(res=>{
        Swal.fire({
